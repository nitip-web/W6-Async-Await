...
document.addEventListener('DOMContentLoaded', async function () {
    ...
    loadButton.addEventListener('click', async function () {
        ...
        //const nameofvariable = js js('filename')
        try {
            ...
            // YOUR CODE HERE:
            updateStatus('failure', 'Data loading failed!');
            console.log(error)
        }
    });
            ...
            restaurants.forEach(function (restaurant) {
                ...
                <div class="restaurant-item">
                    ...
                    <div>
                        ...
                        <span class="restaurant-price">Price: ${restaurant.priceRange}</span>
                    </div>
                </div>
            `;
            });
    ...
    filterButton.addEventListener('click', function () {
        ...
        if (restaurants.length === 0) {
            ...
            const cheapRestaurants = restaurants.filter(function (restaurant) {
                return restaurant.priceRange.length < 3
            })
    ...
    errorButton.addEventListener('click', async function () {
        ...
        try {
            ...
            // YOUR CODE HERE:
               ...
               <p class="status-message">Oops! That request failed. This is a demo of error handling.</p>
                    <p class="status-message">Please check the URL or try again. (${error.message})</p>
                </div>
            `;
